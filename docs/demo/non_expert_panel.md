# How to read this map (for non-experts)
...
|---|---|
| <span style="color:#2e7d32">■</span> Unburnt | The vegetation was not visibly burned in the satellite image. |
| <span style="color:#fdd835">■</span> Low-Moderate | Some scorching, leaves/grass affected, but the trees likely survived. |
| <span style="color:#ef6c00">■</span> High | Significant burning, canopy loss in many trees. |
| <span style="color:#c62828">■</span> Very High | The fire was hot enough that almost no green vegetation survived. |
