...
def train_xgb(
    config_path: str = "configs/experiments/xgb_multiclass.yaml", overrides: list[str] | None = None
) -> dict:
...
def main() -> None:
    ...
    args = p.parse_args()
    train_xgb(args.config, overrides=args.overrides)
